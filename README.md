...
There is a jar file available in the releases section. You will still need to put your API key in to the environment variable (see below). If you prefer building the app from scratch, you can use Gradle.
...
- the max PDF file limit is 50MB. That value can be changed in `application.yml`.
